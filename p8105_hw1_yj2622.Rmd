...
* Brief Description of `penguins`
  * The variables include `r names(penguins)`.
    ...
    * bill_depth_mm ranges from `r min(pull(penguins,bill_depth_mm),na.rm = T)` mm to `r max(pull(penguins,bill_depth_mm),na.rm = T)` mm, with he median of `r median(pull(penguins,bill_depth_mm),na.rm = T)` mm.
